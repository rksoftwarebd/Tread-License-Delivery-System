                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <form action="{{ route('supervisor.verified_by_sp_store') }}" method="post">
                                    @csrf
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select name="call_type" class="form-control">
                                            ...
                                            <option value="sp_1st_call">1st Time Call</option>
                                            <option value="sp_2nd_call">2nd Time Call</option>
                                            <option value="sp_3rd_call">3rd Time Call</option>
                                        </select>
                                        @error('call_type')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $trade_licence->sp_1st_call}}</td>
                                            <td>{{ $trade_licence->sp_1st_status}}</td>
                                            <td>{{ $trade_licence->sp_2nd_call}}</td>
                                            <td>{{ $trade_licence->sp_2nd_status}}</td>
                                            <td>{{ $trade_licence->sp_3rd_call}}</td>
                                            <td>{{ $trade_licence->sp_3rd_status}}</td>
