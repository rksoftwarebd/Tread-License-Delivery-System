                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-body box-profile">
                                ...
                                <p class="text-muted text-center">{{ Auth::user()->zone }}</p>

                                <ul class="list-group list-group-unbordered mb-3">
                                    <li class="list-group-item">
                                        <b><i class="far fa-address-card mr-1"></i></i>ID :</b> <a
                                            class="float-right">{{ Auth::user()->id }}</a>
                                    </li>
                                    <li class="list-group-item">
                                        <b><i class="fas fa-calendar-week mr-1"></i>Joined :</b> <a
                                            class="float-right">{{ Auth::user()->created_at->format('d M, Y') }}</a>
                                    </li>
                                    <li class="list-group-item">
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <a class="float-right">
                                            @foreach ($supervisor_name as $supervisor)
                                                @if ($supervisor->zone == Auth::user()->zone && $supervisor->status == "active")
                                                    {{ $supervisor->name }}
                                                @endif
                                            @endforeach
                                        </a>
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="edit">
                                        <form action="{{ route('deliveryman.profile_update') }}" method="post"
